...
// #endif
        ...
        XRotation = transform.eulerAngles.x + ( speed * Time.deltaTime * Input.GetAxis("Mouse Y"));
        YRotation = target.transform.eulerAngles.y + 180 + (speed * Time.deltaTime * Input.GetAxis("Mouse X"));
        ZRotation = 0;
