...
public class EnemySpawner4 : MonoBehaviour
{
    ...
    public int negxPos = -24, posxPos = 8, negzPos = 1, poszPos = 30, enemyCount = 6;
    public Turn player;
    ...
    IEnumerator EnemyDrop()
    {
        while (i < enemyCount)
        {
            ...
            if (i == 1)
            {
                ...
                target.leftWayPoint = -49;
                target.rightWayPoint = -17;
            } else if (i == 5) {
                target.leftWayPoint = -27;
                target.rightWayPoint = 3;
            } else {
